...
function continueGame() {
  ...
  noticeBoxText.innerHTML=`根據鑰匙提示，轉動外環。<br>
  鑰匙+1代表順時針轉1格，-1代表逆時針轉1格。<br>
  外環字母為密文，對應到的內環字母就是明文。<br>
  輸入答案後送出。總共有10題喔！`
  ...
  // 新的click事件監聽器
  disc.addEventListener("mousedown", handleClick);
  disc.addEventListener("mouseup", handleUp);
